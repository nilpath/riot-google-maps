...
exports.InfoBoxTag = _interopRequire(_tagsInfoBoxTag);

},{"./mixins":8,"./tags/InfoBox.tag":9}],5:[function(require,module,exports){
'use strict';
...
var _InfoBoxEventsJs = require('./InfoBoxEvents.js');

exports.infoBoxEvents = _interopRequire(_InfoBoxEventsJs);

},{"./InfoBoxEvents.js":5}],7:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, '__esModule', {
  value: true
});
exports['default'] = InfoBoxMixin;
...
var infoBoxUpdaters = {
  ...
  options: function options(_options, tag) {
    tag.infoBox.setOptions(_options);
  },
  position: function position(_position, tag) {
    tag.infoBox.setPosition(_position);
  },
  zIndex: function zIndex(_zIndex, tag) {
    tag.infoBox.setZIndex(_zIndex);
  },
  visibile: function visibile(visible, tag) {
    tag.infoBox.setVisible(visible);
  }
};
...
function InfoBoxMixin() {
  ...
  this.onMount = function () {
    ...
    var infoBoxOptions = (0, _utils.composeOptions)(INFO_BOX_OPTIONS, this.opts);
    this.infoBox = this.createInfoBox(infoBoxOptions);
    this.registeredEvents = (0, _utils.registerEvents)(_events.infoBoxEvents, this.opts, this.infoBox);
  ...
  this.createInfoBox = function (options) {
    var infoBox = new _googleMapsInfobox2['default'](options);
...
var _InfoBoxMixin = require('./InfoBoxMixin');

exports.InfoBoxMixin = _interopRequire(_InfoBoxMixin);

},{"./InfoBoxMixin":7}],9:[function(require,module,exports){
(function (global){
var riot = (typeof window !== "undefined" ? window['riot'] : typeof global !== "undefined" ? global['riot'] : null);
module.exports = riot.tag2('info-box', '<yield></yield>', '', '', function(opts) {
    this.mixin('InfoBoxMixin', 'StateMixin');
});
...
},{"equals":1}],11:[function(require,module,exports){
"use strict";
...
},{"./applyUpdaters":10,"./composeOptions":11,"./registerEvents":13,"./unregisterEvents":14}],13:[function(require,module,exports){
"use strict";
